...
public class VorstellungTest
{
    ...
    public void testeKonstruktor()
    {
        ...
        assertEquals(Geldbetrag.getGeldbetrag(1230), v.getPreis());
    ...
    public void testeGibPreisFuerPlaetze()
    {
        ...
        // TODO Blatt09 erledigt
        assertEquals(Geldbetrag.getGeldbetrag(0), v.getPreisFuerPlaetze(s));

        s.add(Platz.get(5, 5));
        s.add(Platz.get(5, 6));
        s.add(Platz.get(5, 7));

        assertEquals(Geldbetrag.getGeldbetrag(3690), v.getPreisFuerPlaetze(s));
    }
